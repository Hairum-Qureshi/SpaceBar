			...
			>
				...
				{imageCount === 3 && (
					<div className="grid grid-cols-3 grid-rows-2 gap-4">
						{/* Top-left square */}
						<div className="border-2 aspect-square flex items-center justify-center overflow-hidden rounded-md">
							<img
								src={images[0]}
								alt="Image 1"
						...
						<div className="border-2 col-span-2 row-span-2 flex items-center justify-center overflow-hidden rounded-md">
							<img
								src={images[1]}
								alt="Image 2"
								className="w-full h-full object-cover"
